        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-3 mb-4 stretch-card transparent">
              <a href="<?php echo site_url('admin/Dashboard/ListSampah') ?>" class="card card-tale" style="text-decoration: none;">
                <div class="card-body">
            ...
            <div class="col-md-3 mb-4 stretch-card transparent">
              <a href="<?php echo site_url('admin/Dashboard/ListUserAkun') ?>" class="card card-dark-blue" style="text-decoration: none;">
                <div class="card-body">
                  <h4 class="mb-4"><b>Total Semua User </b></h4>
                  <p class="fs-30 mb-2"><b><?php echo $maxuser->totasUser ?></b></p>
                  <p>Total Sampai Saat ini</p>
                </div>
              </a>
            </div>
          </div>
